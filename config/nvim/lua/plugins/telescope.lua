return {
    {
        ...
        config = function()
            ...
            keymap("n", "gd", builtins.lsp_definitions, default_opts)
            keymap("n", "gt", builtins.lsp_type_definitions, default_opts)
            keymap("n", "gi", builtins.lsp_implementations, default_opts)
            keymap("n", "gic", builtins.lsp_incoming_calls, default_opts)
            keymap("n", "goc", builtins.lsp_outgoing_calls, default_opts)
            keymap("n", "gr", builtins.lsp_references, default_opts)
